...
declare var $;
@Component({
  selector: 'app-private-company-registration',
  templateUrl: './private-company-registration.component.html',
  styleUrls: ['./private-company-registration.component.scss']
})
export class PrivateCompanyRegistrationComponent implements OnInit {
  ...
  saveForm(payload) {
    this.service.savePrivateCompanyRegistration(payload)
      .subscribe(() => {
        this.dataService.check_out_data = {
          ...
          amount: environment.PRIVATE_COMPANY_REGISTRATION
        }
