...
declare var $;
@Component({
  selector: 'app-rent-agreement-registered',
  templateUrl: './rent-agreement-registered.component.html',
  styleUrls: ['./rent-agreement-registered.component.scss']
})
export class RentAgreementRegisteredComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    if(this.service.document) {
      ...
      'rent_in_rs':this.service.document.rent_in_rs,
      'deposite_in_rs':this.service.document.deposite_in_rs,
      'duration_in_month':this.service.document.duration_in_month,
      }
  ...
  save(form: NgForm) {
    if(form.valid) {
      ...
      formData.append('rent_in_rs', form.control.get('rent_in_rs').value)
      formData.append('deposite_in_rs', form.control.get('deposite_in_rs').value)
      formData.append('duration_in_month', form.control.get('duration_in_month').value)
  ...
  saveForm(payload) {
    this.service.saveRentAgreementRegistered(payload)
      .subscribe(() => {
        this.dataService.check_out_data = {
          ...
          amount: environment.RENT_AGREEMENT_REGISTERED
        }
